export default {
    ...
    dashboard: {
        ...
        timer: {
            ...
            helpTip: 'Dostosuj minuty i sekundy używając przycisków + i -, lub strzałek w górę i w dół na klawiaturze. Maksymalnie 1 godzina.',
            invalid: 'Proszę wprowadzić prawidłowe wartości minut/sekund. Dozwolony zakres to od 1 sekundy do 60 minut.',
